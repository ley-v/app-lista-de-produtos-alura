...
public class ListaProdutosActivity extends AppCompatActivity {
    ...
    private static final String MENSAGEM_ERO_REMOCAO = "Não foi possível remover o produto";
    private static final String MENSAGEM_ERRO_SALVA = "Não foi possível adicionar o produto";
    ...
    private void configuraListaProdutos() {
        ...
        adapter.setOnItemClickRemoveContextMenuListener((posicao, produtoEscolhido) ->
                repository.remove(produtoEscolhido, new ProdutoRepository.DadosCarregadosCallback<Void>() {
                    ...
                    @Override
                    public void quandoFalha(String erro) {
                        mostraErro(MENSAGEM_ERO_REMOCAO);
                    }
                }));
    }
